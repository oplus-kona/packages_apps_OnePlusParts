...
class GameTouchTileService : TileService() {
    ...
    override fun onStartListening() {
        ...
        updateUI(TouchUtils.isGameTouchEnabled(this))
    }
    ...
    override fun onClick() {
        ...
        TouchUtils.setGameTouchEnabled(this, newState)
        updateUI(newState)
    }
    ...
    companion object {
        ...
        fun updateTile(context: Context) {
            requestListeningState(
                context,
                ComponentName(context, GameTouchTileService::class.java)
            )
        }
    }
}
